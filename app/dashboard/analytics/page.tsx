    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="rounded-lg border bg-card p-4">
          ...
          <p className="text-2xl font-bold mt-1">{totalUniqueViews.toLocaleString()}</p>
        </div>
        <div className="rounded-lg border bg-card p-4">
          <div className="flex items-center gap-2 text-muted-foreground text-sm">
          ...
          <p className="text-2xl font-bold mt-1">{sharesWithViews}</p>
        </div>
        <div className="rounded-lg border bg-card p-4">
          <div className="flex items-center gap-2 text-muted-foreground text-sm">
          ...
          <p className="text-2xl font-bold mt-1">{avgViewsPerShare}</p>
        </div>
      </div>
      ...
      {hasData ? (
        <div className="space-y-4">
          <h2 className="text-lg font-semibold">Top Performers (30d)</h2>
