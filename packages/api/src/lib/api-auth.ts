/**
 * API key authentication middleware for Hono API endpoints.
...
/**
 * Validate the API key from an Authorization header string.
 * Returns the authenticated user ID, key ID, and optional team ID, or null if invalid.
 *
 * @param authHeader - Raw value of the Authorization header (e.g. "Bearer shk_...")
 */
