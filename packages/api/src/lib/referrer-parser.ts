import type { ReferrerSource } from "@dropitx/shared/types/analytics";
 ...
 * @param appHost Optional app host to treat as "direct" traffic.
 */
export function parseReferrer(
  ...
  try {
    ...
    if (appHost && url.host === appHost) return "direct";
